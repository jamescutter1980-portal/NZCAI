/**
 * UK SIC 2007 condensed code list (the subset Companies House accepts on
 * confirmation statements). Reproduced verbatim from
 * https://raw.githubusercontent.com/datasets/uk-sic-2007-condensed/master/data/uk-sic-2007-condensed.csv
 * (731 codes; datapackage licence OGL-UK-3.0, adapted from ONS data).
 * Codes are zero-padded to five digits, matching Companies House sic_codes.
 */
export const SIC_2007: Record<string, string> = {
...
export function sicDescription(code: string): string | undefined {
  const key = code.trim().padStart(5, "0");
  return SIC_2007[key];
}
