...
export const referenceDefinitions: IntegrationDefinition[] = [
  ...
  ref({
    id: "ni-historic-environment",
    name: "Historic Environment Record of Northern Ireland",
    group: "identity",
    access: "gis",
    territory: "Northern Ireland",
    description: "Listed buildings, scheduled monuments and other heritage designations in Northern Ireland, held by the Department for Communities. Wales and Scotland now have their own connectors (Cadw, HES).",
    docsUrl: "https://www.communities-ni.gov.uk/services/historic-environment-record-northern-ireland",
    attribution: "Department for Communities, Northern Ireland",
    licence: "OGL",
    notes: ["Designations are published via the HERoNI map viewer and OpenDataNI; a point-query service URL has not been confirmed.", "Build as an ArcGIS or WFS point query with the shared helpers once a service URL is captured from the viewer."],
    links: [
      ...
      { label: "OpenDataNI", url: "https://www.opendatani.gov.uk/" },
    ],
  }),
];
