...
export const referenceDefinitions: IntegrationDefinition[] = [
  ...
  ref({
    id: "desnz-subnational-consumption",
    name: "DESNZ sub-national energy consumption statistics",
    group: "energy",
    access: "download",
    territory: "GB",
    description: "Annual gas and electricity consumption by postcode, LSOA, MSOA and local authority. Benchmarking and estimation where no meter data exists. Also ND-NEED for non-domestic consumption by sector and floor-area band.",
    docsUrl: "https://www.gov.uk/government/collections/sub-national-electricity-consumption-data",
    attribution: "Contains public sector information licensed under the Open Government Licence v3.0. Source: Department for Energy Security and Net Zero.",
    licence: "OGL",
    notes: ["Postcode-level files are large CSVs published each December for the previous year (2024 data published December 2025; 2025 data due December 2026).", "Use as a fallback with basis 'estimated', never as measured consumption for an asset."],
    links: [
      { label: "Sub-national electricity consumption", url: "https://www.gov.uk/government/collections/sub-national-electricity-consumption-data" },
      { label: "Sub-national gas consumption", url: "https://www.gov.uk/government/collections/sub-national-gas-consumption-data" },
      { label: "ND-NEED", url: "https://www.gov.uk/government/collections/non-domestic-national-energy-efficiency-data-framework-nd-need" },
    ],
  }),
  ref({
  ...
  ref({
    ...
    access: "download",
    territory: "UK",
    description: "Quarterly extract of renewable electricity projects above 150 kW through planning, with location, technology, capacity and status. Useful for nearby generation and PPA context.",
    docsUrl: "https://www.gov.uk/government/publications/renewable-energy-planning-database-monthly-extract",
    attribution: "Contains public sector information licensed under the Open Government Licence v3.0. Source: DESNZ.",
    licence: "OGL",
    notes: ["CSV extract with OS grid references; import and query by distance."],
    links: [{ label: "REPD extract", url: "https://www.gov.uk/government/publications/renewable-energy-planning-database-monthly-extract" }],
  }),
  ref({
    id: "ons-geography-imd",
    name: "ONS Postcode Directory and Indices of Deprivation",
    group: "company",
    access: "download",
    territory: "UK / England",
    description: "ONSPD maps every postcode to statistical geographies; the English Indices of Deprivation give LSOA-level deprivation ranks and domains for community context.",
    docsUrl: "https://geoportal.statistics.gov.uk/",
    attribution: "Contains OS data © Crown copyright and database right; contains National Statistics data © Crown copyright and database right. IMD: MHCLG, Open Government Licence v3.0.",
    licence: "OGL",
    notes: ["postcodes.io already serves the ONSPD lookups needed for a single postcode; import the IMD file to join deprivation deciles to the LSOA code it returns.", "Scotland (SIMD), Wales (WIMD) and Northern Ireland (NIMDM) have separate indices that are not comparable with the English IMD."],
    links: [
      { label: "ONS Open Geography portal", url: "https://geoportal.statistics.gov.uk/" },
      { label: "English Indices of Deprivation", url: "https://www.gov.uk/government/collections/english-indices-of-deprivation" },
    ],
  }),
  ref({
    id: "ea-lidar",
